...
os.environ["PATH"] = os.environ["PATH"]+":/usr/local/cuda/lib64"
os.environ["PATH"] = os.environ["PATH"]+":/usr/local/cuda_1222/lib64"
os.environ["PATH"] = os.environ["PATH"]+":/usr/local/cuda_1251/lib64"
